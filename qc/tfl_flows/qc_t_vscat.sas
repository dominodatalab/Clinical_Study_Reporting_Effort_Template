...
* Assign values to these macro variables. I have no idea where they are coming from;
  ...
  %let __prog_path = /mnt/code/qc_t_vscat.sas;
...
ods pdf file = "/workflow/outputs/qc_t_vscat"
        style = newstyle;
...
proc report data = add_param_results_stat headline split = "*" style(report) = {width = 100% cellpadding = 3} out = outputs.qc_t_vscat_data;
